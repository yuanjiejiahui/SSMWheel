...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/mybatis?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true
    username: root
...
<mapper namespace="com.vector.admin.mapper.TeacherMapper">
    <select id="getTeacher" resultType="com.vector.admin.Bean.Teacher">
...
![image-20220122155601458](C:\Users\78235\AppData\Roaming\Typora\typora-user-images\image-20220122155601458.png)
...
![image-20220109231337566](C:\Users\78235\AppData\Roaming\Typora\typora-user-images\image-20220109231337566.png)
...
jdbc.url=jdbc:mysql://localhost:3306/hospital_information?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true
jdbc.username=root
...
- 编写mybatis的核心配置文件
  ...
  <!--    不想写参数全类名去,而给实体类的包设置相对路径-->
      <typeAliases>
          <package name="com.vector.domain"/>
      </typeAliases>
...
2. log4j.properties
   ...
   log4j.appender.file.File=./log/wjh.log
